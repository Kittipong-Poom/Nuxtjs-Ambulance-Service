      ...
      <main class="p-6 sm:p-10 space-y-6">
        <div class="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-center">
          <div class="mr-6 text-center d-flex justify-center">
            <h1 class="text-4xl font-bold mb-2 uppercase">Dashboard</h1>
          </div>
        </div>
        ...
        <section class="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
          ...
          <div class="flex items-center p-8 bg-white shadow rounded-lg">
            <div
              ...
              <svg width="98px" height="98px" viewBox="-348.16 -348.16 1720.32 1720.32"
        ...
        <section class="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
          ...
          <div class="flex items-center p-8 bg-white shadow rounded-lg">
            <div
              class="inline-flex flex-shrink-0 items-center justify-center h-16 w-16 text-blue-600  rounded-full mr-6">
        ...
        <v-row justify="center" align="center" class="pa-4 w-full">
