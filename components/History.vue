    ...
    <v-dialog v-model="dialog" max-width="400">
      <div class="card">
        <div class="card-content">
          ...
          <v-list-item v-for="appointment in appointments" :key="appointment.id" class="card-description d-flex flex-row justify-center align-center">
          ...
          <v-divider v-if="appointments.length > 1 && index < appointments.length - 1"
